...
export function WMS() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-semibold text-gray-900 mb-2">{t('wmsTitle')}</h1>
        <p className="text-gray-600">{t('wmsDesc')}</p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="mb-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('storageCells')}</h2>
            
            <div className="flex gap-6 mb-4">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-green-100 border border-green-300 rounded"></div>
                <span className="text-sm text-gray-600">{t('free')} ({cells.filter(c => c.status === 'free').length})</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-red-100 border border-red-300 rounded"></div>
                <span className="text-sm text-gray-600">{t('occupied')} ({cells.filter(c => c.status === 'occupied').length})</span>
              </div>
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-yellow-100 border border-yellow-300 rounded"></div>
                <span className="text-sm text-gray-600">{t('maintenance')} ({cells.filter(c => c.status === 'maintenance').length})</span>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <h2 className="text-lg font-semibold text-gray-900 mb-2">{t('selfService')}</h2>
          <p className="text-sm text-gray-600 mb-6">{t('selfServiceDesc')}</p>
          ...
          <div className="space-y-6">
            ...
            <div className={`p-4 rounded-lg border-2 ${
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{t('scanDocument')}</h3>
                  <p className="text-xs text-gray-600 mb-3">{t('scanDocumentDesc')}</p>
                  {selfServiceStep === 'scan' && (
                    <div className="mb-3">
            ...
            <div className={`p-4 rounded-lg border-2 ${
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{t('placeInCell')}</h3>
                  <p className="text-xs text-gray-600 mb-3">{t('placeInCellDesc')}</p>
            ...
            <div className={`p-4 rounded-lg border-2 ${
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{t('autoMeasure')}</h3>
                  <p className="text-xs text-gray-600 mb-3">{t('autoMeasureDesc')}</p>
                  {selfServiceStep === 'measure' && (
                  ...
                  {selfServiceStep === 'confirm' && (
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 p-2 bg-white rounded border border-gray-200">
                        ...
                        <span className="font-semibold">{measurements.weight} кг</span>
                      </div>
                      <div className="flex items-center gap-2 p-2 bg-white rounded border border-gray-200">
                        <Ruler className="w-4 h-4 text-gray-500" />
                        <span className="text-sm text-gray-600">{t('dimensions')}:</span>
                        <span className="font-semibold">{measurements.dimensions} см</span>
                      </div>
                    </div>
                  )}
                </div>
            ...
            <div className={`p-4 rounded-lg border-2 ${
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900 mb-1">{t('confirmShipment')}</h3>
                  <p className="text-xs text-gray-600 mb-3">{t('confirmShipmentDesc')}</p>
                  {selfServiceStep === 'confirm' && (
                    <>
                      <div className="mb-3 p-3 bg-white rounded border border-gray-200 flex justify-center">
                        <div className="w-32 h-32 border-2 border-gray-300 rounded flex items-center justify-center">
