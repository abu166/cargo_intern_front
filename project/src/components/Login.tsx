...
export function Login() {
  ...
  const roles = [
    ...
    { id: 'corporate' as UserRole, name: 'Корпоративный клиент', icon: Building2, demo: 'corporate@mail.kz' },
    { id: 'individual' as UserRole, name: 'Физическое лицо', icon: User, demo: 'user@mail.kz' },
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            <p className="text-xs text-center text-gray-500">
              Демо-версия системы. Нажмите "Демо" для быстрого входа.
            </p>
          </div>
        </div>
      </div>
